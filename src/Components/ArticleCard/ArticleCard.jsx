...
export default function ArticleCard({ title, image, short_name, description ,created_at }) {
    return (
        <>
            <Link to={`/article/${short_name}`}>
                <div className='br10 bg-body-tertiary'>
                    ...
                    <div className='d-flex justify-content-between px-3 mt-3 border-bottom pb-3 align-items-center'>
                        <div className='d-flex align-items-center'>
                            <CiUser className='fs20 ms-1 text-secondary' />
