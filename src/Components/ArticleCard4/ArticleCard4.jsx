...
export default function ArticleCard4({title, cover, description, shortName ,createdAt}) {
    return (
        <>
            <Link to={`/article/${shortName}`} className='text-dark'>
                <div className='d-md-flex d-block position-relative bg-body-secondary mt-4 pb-4 pb-md-0'>
                    <img src={`${process.env.REACT_APP_COURSE_IMG}/${cover}`} className='blog-card-img' alt=""/>
                    <div className='px-4 px-md-3'>
                       ...
                       <span className=''>
                        ...
                        <div className='mt-3'>
                            ...
                            <span className='text-secondary fs14 -ver-2 ffv' dir='ltr'>{createdAt.slice(0,10)}</span>
                        </div>
                    </div>
                </div>
            </Link>
